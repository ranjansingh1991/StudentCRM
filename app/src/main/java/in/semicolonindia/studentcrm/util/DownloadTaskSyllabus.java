...
/**
 * Created by RANJAN SINGH on 12/7/2017.
 */
@SuppressWarnings("ALL")
public class DownloadTaskSyllabus extends AsyncTask<String, String, String> {
    ...
    public DownloadTaskSyllabus(Activity activity, String sFileName) {
    ...
    protected String doInBackground(String... parms) {
        ...
        try {
            ...
            URL url = new URL(sSyllabusDocDownloadURL + sFileName);
