package in.semicolonindia.studentcrm.widgets;
...
/**
 * Created by Rupesh on 14-10-2017.
 */

@SuppressWarnings("ALL")
public class AVLoadingIndicatorViewLight extends View {
    ...
    public AVLoadingIndicatorViewLight(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public AVLoadingIndicatorViewLight(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, R.style.AVLoadingIndicatorView);
    }

    public AVLoadingIndicatorViewLight(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AVLoadingIndicatorViewLight(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, 0xFFFFFFFF);
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            Class<?> drawableClass = Class.forName("in.semicolonindia.studentcrm.widgets.SquareSpinIndicator");
