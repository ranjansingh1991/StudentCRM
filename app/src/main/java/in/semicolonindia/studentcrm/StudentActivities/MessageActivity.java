...
import in.semicolonindia.studentcrm.StudentAdapters.MessageListAdapter;
...
public class MessageActivity extends AppCompatActivity { /*implements View.OnClickListener*/
    ...
    private void getMessages() {
        final ProgressDialog mProgressDialog = new ProgressDialog(MessageActivity.this, "Loading Messages...");
                ...
                if (sResult != null) {
                    ...
                    try {
                        ...
                        if (jsonObject.getJSONArray("teachers").length() > 0) {
                            ...
                            mMessageListAdapter = new MessageListAdapter(getApplicationContext(), arraylist);
