package in.semicolonindia.studentcrm.calendar;
...
import in.semicolonindia.studentcrm.calendar.formats.ArrayWeekDayFormatter;
import in.semicolonindia.studentcrm.calendar.formats.DateFormatTitleFormatter;
import in.semicolonindia.studentcrm.calendar.formats.DayFormatter;
import in.semicolonindia.studentcrm.calendar.formats.MonthArrayTitleFormatter;
import in.semicolonindia.studentcrm.calendar.formats.TitleChanger;
import in.semicolonindia.studentcrm.calendar.formats.TitleFormatter;
import in.semicolonindia.studentcrm.calendar.formats.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            titleChanger.setOrientation(a.getInteger(R.styleable.MaterialCalendarView_mcv_titleAnimationOrientation,
                    VERTICAL));
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.left_arrow_light_solid);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.right_arrow_light_solid);
            }
    ...
    /**
     * @return The current month shown, will be set to home_menu day of the month
     */
    ...
    /**
     * @return The home_menu day of the week as a {@linkplain Calendar} day constant.
     */
     ...
     *
     * @param firstDay home_menu day enclosing a range
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        counter.setTime(firstDay.getDate());  //  start from the home_menu day and increment
     ...
     * Dispatch date change events to a listener, if set
     *
     * @param day home_menu day of the new month
     */
    ...
    /**
     * Select a fresh range of date including home_menu day and last day.
     *
     * @param firstDay home_menu day of the range to select
     ...
     * @param dayView
     */
    public void onDateClicked(final DayView dayView) {
    ...
    public class StateBuilder {
        ...
        /**
         * Sets the home_menu day of the week.
         * <p>
         * Uses the java.util.Calendar day constants.
         *
         * @param day The home_menu day of the week as a java.util.Calendar day constant.
         * @see Calendar
         */
