...
public class CalendarUtils {
    ...
    /**
     * Set the provided calendar to the home_menu day of the month. Also clears all time information.
     *
     * @param calendar {@linkplain Calendar} to modify to be at the home_menu fay of the month
     */
